...
export default function CertificationsView() {
  ...
  return (
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-2xl shadow-lg p-8 border border-yellow-200 dark:from-slate-900 dark:to-slate-800 dark:border-slate-800">
      ...
      <div className="grid gap-6">
        {certifications
          ...
          .map((cert) => (
            <div key={cert.id} className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all border border-gray-100 p-6 dark:bg-slate-900 dark:border-slate-800">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-700 mb-4 leading-relaxed dark:text-gray-300">{cert.description}</p>
                  <div className="flex flex-wrap items-center gap-3 mb-4">
                    <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-sm font-medium dark:bg-slate-800 dark:text-gray-200">
                      {cert.difficulty_level}
                    </span>
                    <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-sm font-medium dark:bg-blue-900/40 dark:text-blue-200">
                      {cert.estimated_study_hours} hours
                    </span>
                    <span className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium dark:bg-purple-900/40 dark:text-purple-200">
                      Priority: {cert.priority}/5
                    </span>
                  </div>
                  <div className="bg-gradient-to-r from-primary-50 to-blue-50 border-l-4 border-primary-500 p-4 rounded-lg dark:from-slate-800 dark:to-slate-900 dark:border-primary-400">
              ...
              <div className="flex items-center justify-between mt-6 pt-4 border-t border-gray-200 dark:border-slate-800">
                ...
                <select
                  ...
                  className="px-4 py-2 border-2 border-gray-300 rounded-lg text-sm font-medium focus:ring-2 focus:ring-primary-500 focus:border-primary-500 disabled:opacity-50 bg-white text-gray-900 dark:bg-slate-900 dark:border-slate-700 dark:text-gray-100"
                >
